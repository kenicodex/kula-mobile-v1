...
async function chefSignUpAndHydrate(
...
export default function ChefSignUpScreen() {
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: ({ name, email, phone, password }: FormValues) =>
      chefSignUpAndHydrate({ name, email, phone, password }),
    ...
    <ScreenWrapper scrollable statusBarStyle="dark">
      ...
      <View style={styles.body}>
        ...
        <View style={styles.titleBlock}>
          ...
          <Text style={styles.title}>Create chef account</Text>
          <Text style={styles.subtitle}>
            Start your journey as a professional chef on Kula.
          </Text>
        </View>

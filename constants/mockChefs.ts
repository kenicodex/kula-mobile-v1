import { ChefListItem } from '@/components/chef/ChefCard';

export const MOCK_CHEFS: ChefListItem[] = [
  {
    id: '1',
    name: 'Amaka Obi',
  ...
  },
  {
    ...
    location: 'Wuse, Abuja',
    coverImageUrl:
      'https://images.unsplash.com/photo-1578985545062-6d37f5c94a45?w=600&q=80&fit=crop',
    tags: ['Pastry', 'Wedding Cakes'],
  },
  {
    id: '4',
    name: 'Bayo Ade',
    ...
    coverImageUrl:
      'https://images.unsplash.com/photo-1555939594-e5b0efd3f8d9?w=600&q=80&fit=crop',
    tags: ['Grills', 'BBQ'],
  },
  {
    id: '5',
    name: 'Ngozi Catering',
    cuisine: 'Continental · Event',
    rating: 4.7,
    bookingCount: 392,
    basePrice: 80000,
